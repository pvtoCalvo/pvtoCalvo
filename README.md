<p align="center">
  <img src="./banner.svg" width="100%" alt="pvtoCalvo — Sistemas. Código. Un poco de RPG. Linux, Rust, TypeScript y Python." />
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Una TUI para administrar nftables e iptables: reglas, copias de seguridad, restauración y modo dry-run.</p>
      <p><code>Rust</code> <code>ratatui</code> <code>Linux</code></p>
